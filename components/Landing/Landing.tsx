      ...
      <div className="relative pt-6 pb-16 sm:pb-24">
        <main className="mt-16 mx-auto max-w-7xl px-16 sm:mt-24">
          <div className="text-center">
            ...
            >
              <span className="block text-palewhite xl:inline drop-shadow-xl font-semibold text-base md:text-2xl my-3 tracking-[0.2em]">
                THE WEDDING OF
              </span>
            </motion.h1>
            ...
            >
              <span className="text-7xl lg:text-9xl font-typography tracking-wider">
                Kelvin & Sherrish
              </span>
            </motion.div>
            <motion.p
              ...
              className="mt-4 text-white font-bold tracking-widest text-sm lg:text-xl font-sans"
            >
              Valid for 2 Persons
            </motion.p>
            <motion.div
