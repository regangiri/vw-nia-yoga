...
export default function HeroHome() {
  ...
  return (
    <div className="relative header bg-fixed overflow-hidden h-screen text-palewhite flex justify-center scrollbar-hide">
          ...
          <div className="text-center">
            ...
            >
              ...
              <p className="font-baskervville text-lg font-bold tracking-wider">
                2 November 2024 | 12:00 WIB (GMT +7)
              </p>

              <div className="mt-5  max-w-md mx-auto sm:flex sm:justify-center justify-center md:mt-8 hover:cursor-pointer">
                <div className="rounded-md  flex justify-center">
                  <Link
                    href={`https://calendar.google.com/calendar/event?action=TEMPLATE&tmeid=M3Y4bXVvczRxNml1bjQ2NWIzaWVka3ZoMTcgOHByZzZydmltcGU0Yzk0cDUxNzZxa3JsbXNAZw&tmsrc=8prg6rvimpe4c94p5176qkrlms%40group.calendar.google.com`}
                    target="_blank"
                  >
